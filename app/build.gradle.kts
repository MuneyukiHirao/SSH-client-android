...
dependencies {
    // SSH Library (ConnectBot's sshlib)
    ...
    // Security - BouncyCastle for key generation
    implementation("org.bouncycastle:bcprov-jdk18on:1.77")
    implementation("org.bouncycastle:bcpkix-jdk18on:1.77")

    // Security - Note: Using Android Keystore directly instead of EncryptedSharedPreferences
    // to avoid Tink class conflicts with sshlib
